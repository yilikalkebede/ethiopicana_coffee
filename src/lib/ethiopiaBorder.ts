/**
 * Ethiopia's national boundary as a simplified polygon of real [longitude,
 * latitude] points -- used only to draw a recognizable outline behind the
 * region markers on the Origins map. Not survey-grade or for navigational/
 * legal use.
 *
 * Source: johan/world.geo.json (github.com/johan/world.geo.json),
 * countries/ETH.geo.json, a public-domain-derived (Natural Earth lineage)
 * dataset -- fetched 2026-09-06. Real data, not hand-drawn or invented,
 * per this project's rule against presenting fabricated geography as
 * authentic.
 */
export const ETHIOPIA_BORDER: [number, number][] = [
